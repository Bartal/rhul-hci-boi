$(document).ready(function () {
    ...
    $('#upButton').click(function () {
        ...
        $('#messageBord').getSelectedMessages().each(function () {
            //get the index of the current element
            var index = $(this).index();
            // if there is some room up
            if (index > 1) {
                // get the previous element in the message handler
                var previous = $('#messageBord').children().eq(index - 1);
    ...
    $('#downButton').click(function () {
        //for each selected message in the main message handler
        $($('#messageBord').getSelectedMessages().get().reverse()).each(function () {
            //get the index of the current element
            var index = $(this).index();
            ...
            if (index < length - 1) {
                // get the previous element in the message handler
                var next = $('#messageBord').children().eq(index + 1);
                // if it's not selected, swap
    ...
    $('#messageBord').BYOIMessageHandler({
